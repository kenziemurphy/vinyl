var HELP_PRESETS = {
    'minor': {
        title: 'Minor Mode',
        body: `
            Data points below this line represent songs that are written in a "minor scale/mode",
            which usually makes them sound sad or darker.
            ` 
    },
    'major': {
        title: 'Major Mode',
        body: `
            Data points above this line represent songs that are written in a "major scale/mode",
            which usually makes them sound happy or bright.
            ` 
    },
    'tempo': {
        title: 'Tempo',
    ...
    'acousticness': {
        title: 'Acousticness',
        body: `A confidence measure from 0.0 to 1.0 of whether the track is acoustic. 1.0 represents high confidence the track is acoustic.` 
    },
    'danceability': {
        title: 'Danceability',
    ...
    'energy': {
        title: 'Energy',
        body: `	Energy is a measure from 0.0 to 1.0 and represents a perceptual measure of intensity and activity. Typically, energetic tracks feel fast, loud, and noisy.` 
    },
    'instrumentalness': {
